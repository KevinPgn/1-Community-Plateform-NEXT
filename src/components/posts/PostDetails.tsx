...
export const PostDetails = ({ post, userId }: any) => {
  ...
  return <div className="border-b relative border-white/10 p-3 flex gap-3 w-full">
    ...
    <div className="flex flex-col gap-2 w-full">
      ...
      <p onClick={() => router.push(`/post/${post.id}`)} className="cursor-pointer">{renderContent()}</p>
      ...
      <div className="flex items-center justify-between mt-3">
        <div className="flex items-center gap-10">
            ...
            <Reposts repostsCount={post._count.reposts} isReposted={post.isReposted} postId={post.id}/>
