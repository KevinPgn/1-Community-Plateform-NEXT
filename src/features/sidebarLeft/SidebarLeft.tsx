...
export const SidebarLeft = async () => {
  ...
  return <aside className="h-screen w-[280px] max-md:w-[100px] sticky top-0 rounded-tr-lg rounded-br-lg bg-[#0b0b0b]">
    <div className="relative">
      <img src={session?.user?.image || ""} loading="lazy" alt={session?.user?.name || ""} width={100} height={100} className="rounded-full w-[100px] h-[100px] mx-auto mt-10 max-md:w-[50px] max-md:h-[50px]" />
    </div>
