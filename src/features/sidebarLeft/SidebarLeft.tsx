...
export const SidebarLeft = async () => {
  ...
  return <aside className="h-screen w-[280px] flex flex-col justify-between pb-10 max-md:w-[100px] sticky top-0 rounded-tr-lg rounded-br-lg bg-white dark:bg-[#0b0b0b]">
